	...
	<div class="wrap js-check-wrap">
		...
		<form class="js-ajax-form" action="" method="post">
			<div class="table-actions">
				<?php if(!empty($term)): ?><button class="btn btn-primary btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminPost/listorders');?>"><?php echo L('SORT');?></button><?php endif; ?>
				...
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminPost/delete');?>" data-subcheck="true" data-msg="您确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
			<table class="table table-hover table-bordered table-list">
				...
				<?php if(is_array($posts)): foreach($posts as $key=>$vo): ?><tr>
					...
					<td>
						...
						<a href="<?php echo U('AdminPost/delete',array('id'=>$vo['id']));?>" class="js-ajax-delete"><?php echo L('DELETE');?></a>
					</td>
			...
			<div class="table-actions">
				...
				<?php if(!empty($term)): ?><button class="btn btn-primary btn-small js-articles-move" type="button">批量移动</button><?php endif; ?>
				<button class="btn btn-primary btn-small js-articles-copy" type="button">批量复制</button>
				<button class="btn btn-danger btn-small js-ajax-submit" type="submit" data-action="<?php echo U('AdminPost/delete');?>" data-subcheck="true" data-msg="你确定删除吗？"><?php echo L('DELETE');?></button>
			</div>
			<div class="pagination"><?php echo ($page); ?></div>
		</form>
	</div>
	<script src="/code/public/js/common.js"></script>
	<script>
		...
		$(function() {
			...
			Wind.use('ajaxForm', 'artDialog', 'iframeTools', function() {
				...
				$('.js-articles-copy').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/code/index.php?g=portal&m=AdminPost&a=copy&ids="+ ids, {
						title : "批量复制",
						width : "300px"
					});
				});
				...
				$('.js-articles-move').click(function(e) {
					...
					ids= ids.join(',');
					art.dialog.open("/code/index.php?g=portal&m=AdminPost&a=move&old_term_id=<?php echo ((isset($term["term_id"]) && ($term["term_id"] !== ""))?($term["term_id"]):0); ?>&ids="+ ids, {
						title : "批量移动",
						width : "300px"
					});
				});
